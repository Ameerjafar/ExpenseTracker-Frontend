    ...
    return (
        <div className = 'h-screen'>
            ...
            <div className = 'md:grid grid-cols-3 gap-3 p-10'>
                ...
                <div className = 'bg-green-300 p-3 rounded-lg'>Remaining:200</div>
                <div className = "bg-blue-300 p-3 rounded-lg">spent so far: 700</div>
            </div>
            ...
            <div className = 'flex p-10 pb-0'>
                <div className = 'flex justify-between border rounded pl-2 pb-2 pt-2 p-10 w-full'>
                    <div className = 'w-4/5'>shopping</div>
                    <div className = 'bg-blue-400 rounded-lg p-1 text-center'>$100</div>
                    <div>X</div>
                </div>
            </div>
            <div className = 'flex p-10 pb-0 pt-0'>
                <div className = 'flex justify-between border rounded pl-2 pb-2 pt-2 p-10 w-full'>
                    <div className = 'w-4/5'>Holiday</div>
                    <div className = 'bg-blue-400 rounded-lg p-1 text-center'>$100</div>
                    <div>X</div>
                </div>
            </div>
            <div className = 'flex p-10 pb-0 pt-0'>
                <div className = 'flex justify-between border rounded pl-2 pb-2 pt-2 p-10 w-full'>
                    <div className = 'w-4/5'>Transpotation</div>
                    <div className = 'bg-blue-400 rounded-lg p-1 text-center'>$100</div>
                    <div>X</div>
                </div>
            </div>
            ...
            <div className = 'flex p-10 pb-0 pt-0'>
                <div className = 'flex justify-between border rounded pl-2 pb-2 pt-2 p-10 w-full'>
                    <div className = 'w-4/5'>Child Care</div>
                    <div className = 'bg-blue-400 rounded-lg p-1 text-center'>$100</div>
                    <div>X</div>
                </div>
            </div>
